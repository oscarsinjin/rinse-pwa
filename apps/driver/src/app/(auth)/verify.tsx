import { PrimaryButton, requestOtp, verifyOtp, type VehicleType } from '@rinse/shared';
...
export default function VerifyScreen() {
  ...
  const { phone, vehicleType } = useLocalSearchParams<{ phone: string; vehicleType: VehicleType }>();
